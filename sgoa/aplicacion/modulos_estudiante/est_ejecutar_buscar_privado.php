        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                ...
                <div class="col-sm-12 text-center"> 
                    ...
                    switch ($criterio) {
                        case 'nombre':
                            $clausula_where = ' where nombre like "%' . $valor_criterio . '%" AND tipo_objeto_aprendizaje <> null order by nombre';
                            $statement = 'select * from objeto_aprendizaje' . $clausula_where;
                            break;
                        case 'descripcion':
                            $clausula_where = ' where descripcion like "%' . $valor_criterio . '%" AND tipo_objeto_aprendizaje <> null order by descripcion';
                            $statement = 'select * from objeto_aprendizaje' . $clausula_where;
                            break;
                        case 'institucion':
                            $clausula_where = ' where institucion like "%' . $valor_criterio . '%" AND tipo_objeto_aprendizaje <> null order by institucion';
                            $statement = 'select * from objeto_aprendizaje' . $clausula_where;
                            break;
                        case 'palabras_clave':
                            $clausula_where = ' where palabras_clave like "%' . $valor_criterio . '%" AND tipo_objeto_aprendizaje <> null order by palabras_clave';
                            $statement = 'select * from objeto_aprendizaje' . $clausula_where;
                            break;
                    }
